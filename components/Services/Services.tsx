  ...
  const services = [
    {
      ...
      icon: Monitor,
      description: 'Llevamos tu proyecto de la idea a la realidad. Con nuestro desarrollo web a medida, tu sitio será funcional, visualmente atractivo y optimizado para los usuarios.',
      features: [
    ...
    },
    {
      ...
      icon: Smartphone,
      description: 'Creamos aplicaciones móviles nativas e híbridas que ofrecen experiencias excepcionales en iOS y Android, adaptadas a tus necesidades específicas.',
      features: [
      ...
      mockupImage: '/api/placeholder/300/400',
    ...
    },
    {
      ...
      icon: Search,
      description: 'Analizamos tu presencia digital actual para identificar oportunidades de mejora y optimización que impulsen tu crecimiento online.',
      features: [
      ...
      mockupImage: '/api/placeholder/400/250',
    ...
    },
    {
      ...
      icon: Settings,
      description: 'Desarrollamos soluciones de software personalizadas que se adaptan perfectamente a los procesos únicos de tu empresa.',
      features: [
      ...
      mockupImage: '/api/placeholder/350/300',
      color: 'from-mewtwo-primary to-mewtwo-secondary'
    }
  ];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                <div className="space-y-6 sm:space-y-8">
                  <div>
                    ...
                    >
                      <service.icon size={32} className="sm:w-10 sm:h-10 text-white" />
                    </motion.div>
                ...
                <div className="relative order-first lg:order-last">
                  <motion.div
                    ...
                    className="relative bg-gradient-to-br from-mewtwo-primary/20 to-mewtwo-secondary/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 min-h-64 sm:min-h-80 flex items-center justify-center"
                  >
                    {/* Mockup Content */}
                    <div className="text-center">
                      <motion.div
                        ...
                        className={`w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 mx-auto mb-4 sm:mb-6 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center shadow-2xl`}
                      >
                        <service.icon size={40} className="sm:w-12 sm:h-12 lg:w-16 lg:h-16 text-white" />
                      </motion.div>

                      <div className="space-y-2 sm:space-y-3">
                        <div className="h-2 sm:h-3 bg-white/20 rounded-full w-3/4 mx-auto"></div>
                        <div className="h-2 sm:h-3 bg-white/15 rounded-full w-1/2 mx-auto"></div>
                        <div className="h-2 sm:h-3 bg-white/10 rounded-full w-2/3 mx-auto"></div>
                      </div>
                    </div>
                    ...
                    <motion.div
                      ...
                      className="absolute top-4 right-4 w-4 h-4 sm:w-6 sm:h-6 bg-mewtwo-secondary/60 rounded-full"
                    />
                    ...
                    <motion.div
                      ...
                      className="absolute bottom-6 left-6 w-3 h-3 sm:w-4 sm:h-4 bg-mewtwo-primary/60 rounded-full"
                    />
                  </motion.div>
                </div>
              </div>
